...
This reflection piece is divided into two parts: one descriptive, another reflective. In the first part the process beginning from the first ideas up to the finished product will be illustrated. The second half reflects on this and reviews the digital methods used, as well as the implications on future historical work. 
